...
e.g. If the latest version of BoxWallet is `0.0.5` a subfolder will be created called `v0.0.5` which will include a `run_boxwallet.bat` file.

Simply change to the directory and run the `run_boxwallet.bat` file and open your browser to `localhost:4000`
